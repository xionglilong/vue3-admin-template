...
<template>
  <div>
    <div id="mains" style="width: 100%; height: 815px; margin: 15px 0; border: 1px solid #333; box-shadow: 5px 5px 5px #888888"></div>
  </div>
</template>
...
const init = async () => {
  ...
  let myChart = echarts.init(document.getElementById('mains') as HTMLElement)
  //let mychart = echarts.init(main.value)
  var ch_credit_in_major =echarts.init(document.getElementById('mains')!);
